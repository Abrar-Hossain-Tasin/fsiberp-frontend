...
const DebitVoucherSubmit = () => {
  ...
  const handleVoucherChange = (event) => {
    ...
    // Reset amount and amountInWords when voucherType changes
    setAmount("");
    setAmountInWords("");
  };
  ...
  //       // Check if the error message indicates file size issue
  //       if (
  //         errorData.message &&
  //         errorData.message.includes("File size exceeds 250 KB")
  //       ) {
  //         toast.error(
