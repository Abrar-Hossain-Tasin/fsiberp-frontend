...
const OfficeNoteViewPrint = () => {
  ...
  useEffect(() => {
    try {
      const fetchData = async () => {
        const response = await fetch(
          `${Base_api}/api/officenote/user/viewform/${userId}/${formId}/${id}`
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${Base_api}/api/officenote/emplist/${userId}`
        );
...
export default OfficeNoteViewPrint;
