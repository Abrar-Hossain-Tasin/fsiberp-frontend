...
import BoardMeetingAdminApproval from "../pages/BoardMeetingAdminApproval";
import MemoAddCheckerEdit from "./MemoAddCheckerEdit";

const BoardMemoViewSideBar = ({
  setAddCheckerUserId,
    ...
    try {
      const fetchData = async () => {
        const response = await fetch(
          ...
          `${Base_api}/api/bm/comments/${decryptedUserId}/${decryptedFormId}/${decryptedId}`
        );
...
export default BoardMemoViewSideBar;
