...
const AdminAcceptReject = ({ status, setStatus, comment, setComment }) => {
  ...
  const unitsWithAccess = [2, 7, 8, 9, 10];
  ...
  // if (bms === "Admin" && (user_roleid === "1" || user_roleid === "2")) {
  ...
  //   if (
  //     userid === formData.secondmanuserid &&
  ...
  //   if (userid === formData.dmduserid && formData.dmdstatus === "Pending") {
  //     return (
  //       <div className="accept-reject-button">
  //         <form>
  //           <input
