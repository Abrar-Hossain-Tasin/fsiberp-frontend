...
const ImpactPotentialImpact = ({ potentialImpact, setPotentialImpact }) => {
  ...
  return (
    <form className="flex gap-1 flex-wrap py-2 text-sm font-[500]">
...
export default ImpactPotentialImpact;
